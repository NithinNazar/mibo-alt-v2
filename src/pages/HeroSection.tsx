...
export default function HeroSection() {
  ...
  const renderIcon = (Icon, size, color) => {
    return <Icon color={color} style={{ width: size, height: size }} />;
  };
          ...
          <div className="px-3 pb-8">
            ...
            >
              {TRUST.map(({ Icon, title, desc, color }, i) => (
                ...
                >
                  <div
                    className="flex-shrink-0 rounded-full bg-[#D1FAF0] flex items-center justify-center animate-pulse"
                    style={{ width: 38, height: 38 }}
                  >
                    {renderIcon(Icon, 18, color)}
                  </div>
                  <div>
                    <p
