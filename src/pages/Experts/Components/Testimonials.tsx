...
// // src/pages/Experts/components/Testimonials.tsx
// import { testimonials } from "../data/testimonials";
// import { motion } from "framer-motion";
...
//             transition={{ duration: 0.4 }}
//             viewport={{ once: true }}
//             className="bg-[#18356C]/60 border border-[#2FA19A]/30 rounded-2xl p-5 w-[280px] flex-shrink-0"
//           >
//             <p className="text-gray-300 italic mb-3">“{t.feedback}”</p>
//             <p className="text-[#2FA19A] font-semibold text-sm">- {t.name}</p>
//           </motion.div>
//         ))}
//       </div>
//     </section>
