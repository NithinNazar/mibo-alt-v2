...
export default function DoctorCard({ doctor }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="relative rounded-xl w-full h-40 mb-3 overflow-hidden">
        <img
          src={doctor.image}
          alt={doctor.name}
          className="w-full h-full object-contain"
          style={{
            objectPosition: '50% 30%', // Adjust this to focus on face
          }}
        />
        {/* Optional: Add a subtle gradient at top for images with white background */}
