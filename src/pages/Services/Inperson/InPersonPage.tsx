...
import { inPersonContent } from "./InPersonData";
import { useNavigate } from "react-router-dom";
import heroImage from "../../../assets/inpersonservice.jpg?w=1200&format=webp&quality=75";
  ...
  return (
    <div className="bg-[#E3F7F1] min-h-screen">
      ...
      <div className="relative w-full h-[60vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white text-center px-6">
          <h1 className="text-4xl font-bold mb-3 drop-shadow-lg">
            {inPersonContent.title}
          </h1>
          <p className="text-lg max-w-2xl drop-shadow-md">
            {inPersonContent.subtitle}
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-2">
        {inPersonContent.sections.map((section, index) => {
