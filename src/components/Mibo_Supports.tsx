import heartAnimation from "../assets/animations/team.json";
import messageAnimation from "../assets/animations/MultiLanguage.json";
      ...
      <motion.div className="flex flex-col items-center space-y-4">
        ...
        >
          <Lottie
            ...
            className="w-28 h-28" // increased size here
            loop={true}
          />
        </motion.div>
        <motion.h2
