...
//     return (
//         <div className="w-full max-w-md mx-auto bg-gradient-to-br from-green-700 to-green-800  p-8 text-white text-center">
//             {/* Header */}
//             <h2 className="text-2xl font-semibold mb-4">Why Amaha?</h2>
//             <p className="text-green-100 text-sm mb-12 leading-relaxed">
//                 Our platform is built by psychiatrists, therapists and mental health experts with immense global experience.
//             </p>

//             {/* Icon Container */}
//             <div className="mb-8">
//                 <div className="w-20 h-20 mx-auto bg-white bg-opacity-10 rounded-xl flex items-center justify-center border-2 border-orange-400 relative">
//                     {activeSlide === 0 && (
//                         <div className="relative">
//                             <div className="w-8 h-8 bg-white rounded-sm"></div>
//                             <div className="absolute -top-1 -right-1 w-6 h-6 bg-orange-400 rounded-sm"></div>
//                             <div className="absolute top-3 left-3 w-3 h-3 bg-orange-400 rounded-full"></div>
//                             <div className="absolute top-1 left-1 w-2 h-2 bg-green-700 rounded-full"></div>
//                         </div>
//                     )}
//                     {activeSlide === 1 && (
//                         <div className="relative">
//                             <div className="w-12 h-8 border-2 border-white rounded-full relative">
//                                 <div className="absolute top-1 left-2 w-2 h-2 bg-orange-400 rounded-full"></div>
//                                 <div className="absolute top-3 left-4 w-1.5 h-1.5 bg-orange-400 rounded-full"></div>
//                                 <div className="absolute top-1 right-2 w-1.5 h-1.5 bg-orange-400 rounded-full"></div>
//                             </div>
//                             <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-6 h-4 border-l-2 border-r-2 border-b-2 border-white rounded-b-md"></div>
//                         </div>
//                     )}
//                     {activeSlide === 2 && (
//                         <div className="relative">
//                             <svg className="w-8 h-8 text-orange-400 fill-current" viewBox="0 0 24 24">
//                                 <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
//                             </svg>
//                             <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
//                                 <div className="w-8 h-3 border-2 border-white rounded-full bg-transparent"></div>
//                             </div>
//                         </div>
//                     )}
//                     {activeSlide === 3 && (
//                         <div className="relative">
//                             <div className="w-10 h-8 border-2 border-white rounded-sm relative">
//                                 <div className="absolute top-1 right-1">
//                                     <div className="w-4 h-3 bg-orange-400 rounded-sm relative">
...
//             {/* Content */}
//             <div className="mb-12">
//                 <h3 className="text-xl font-semibold mb-4">{slides[activeSlide].title}</h3>
//                 <p className="text-green-100 text-sm leading-relaxed">{slides[activeSlide].description}</p>
//             </div>
...
//                             index === activeSlide ? 'bg-orange-400' : 'bg-white bg-opacity-30 hover:bg-opacity-50'
//                         }`}
//                     />
//                 ))}
//             </div>
                            ...
                            <div key={index} className="w-full flex-shrink-0 flex flex-col items-center justify-center">
                                ...
                                <div className="mb-4">
                                    <div className="w-20 h-20 mx-auto bg-white bg-opacity-10 rounded-xl flex items-center justify-center border-2 border-[#18356C] relative">
                                        ...
                                        {index === 2 && (
                                            <div className="relative">
                                                <svg className="w-8 h-8 text-[#18356C] fill-current" viewBox="0 0 24 24">
                                                    <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                                                </svg>
                                                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
                                ...
                                <div className="text-center">
                                    <h3 className="text-[0.8rem] text-[rgb(255, 255, 255] font-[700] mb-2">
                                        {slide.title}
                                    </h3>
                                    <p
                                        className="text-green-100 text-[0.813rem] font-[500] leading-relaxed"
            ...
            <div className="flex justify-center space-x-2">
                {slides.map((_, index) => (
                    <button
                        ...
                        onClick={() => setActiveSlide(index)}
                        className={`w-3 h-3 rounded-full transition-colors duration-200 ${
                            index === activeSlide ? 'bg-[#18356C]' : 'bg-white bg-opacity-30 hover:bg-opacity-50'
                        }`}
                    />
                ))}
            </div>
