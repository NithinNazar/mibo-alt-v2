...
//                                 <span className="text-[#2FA19A] "> life, your people, your pace.</span>
//                             </h1>

//                             <p className="text-[0.8rem] font-500 ml-4 text-gray-600 leading-relaxed max-w-lg">
//                                 Care doesn't happen in isolation. It works when it's rooted in your everyday life. We
//                                 practice care that speaks your language and sees your world.
//                             </p>
//                         </div>
//                     </div>
