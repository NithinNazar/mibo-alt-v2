...
const PremiumCarousel = () => {
  ...
  const slides = [
    ...
    {
      id: 3,
      image: "https://images.unsplash.com/photo-1516534775068-ba3e7458af70?w=1200&h=800&fit=crop",
  ...
  return (
    ...
    >
      ...
      >
        {slides.map((slide, index) => (
          <div key={slide.id} className="relative w-full h-full flex-shrink-0">
            ...
            <div className="absolute bottom-20 left-1/2 -translate-x-1/2 text-center text-white p-4 max-w-2xl">
              <h2
                className={`text-4xl md:text-5xl lg:text-6xl font-bold mb-4 drop-shadow-lg transition-all duration-1000 ${
              ...
              <p
                className={`text-lg md:text-xl opacity-90 drop-shadow transition-all duration-1000 delay-200 ${
      ...
      <button
        ...
        className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 w-12 h-12 md:w-14 md:h-14 bg-black/40 backdrop-blur-sm text-white rounded-full flex items-center justify-center hover:bg-black/60 hover:scale-110 transition-all duration-300 shadow-lg"
      >
        <ChevronLeft size={28} />
      </button>
      ...
      <button
        ...
        className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 w-12 h-12 md:w-14 md:h-14 bg-black/40 backdrop-blur-sm text-white rounded-full flex items-center justify-center hover:bg-black/60 hover:scale-110 transition-all duration-300 shadow-lg"
      >
