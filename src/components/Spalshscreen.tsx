...
const PremiumSplashScreen = ({ onComplete }: PremiumSplashScreenProps) => {
    ...
    //             }`}
    //             style={{
    //                 background: 'linear-gradient(135deg, #18356C 0%, #2FA19A 100%)',
    //             }}
    //         >
    ...
    //                         ></div>
    //                     </div>
    //                     <p className="text-white text-opacity-70 text-sm font-light">Loading your premium experience...</p>
    //                 </div>
        ...
        >
            ...
            <div className="relative flex flex-col items-center space-y-8 px-8 text-center">
                ...
                >
                    ...
                    <p className="text-white text-opacity-70 text-sm font-light">Loading your wellness journey...</p>
                </div>
